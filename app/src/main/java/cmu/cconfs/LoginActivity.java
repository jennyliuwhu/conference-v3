...
public class LoginActivity extends AppCompatActivity {
    ...
    private final static int REQUEST_SIGNUP = 1;
                ...
                ParseUser.logInInBackground(username, password, new LogInCallback() {
                    public void done(ParseUser user, ParseException e) {
                        if (user != null) {
                            ...
                            // 调用sdk登陆方法登陆聊天服务器
                            EMChatManager.getInstance().login(mUsernameText.getText().toString(), mPasswordText.getText().toString(), new EMCallBack() {
                                ...
                                public void onSuccess() {
                                    ...
                                    CConfsApplication.getInstance().setPassword(mPasswordText.getText().toString());
